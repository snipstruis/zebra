...
#include "torus.h" // to add a torus to the map
...
int main(int argc, char** argv){
	...
	while(true){
		...
		//collision_detection(ori, locations_of_circles, 4.f);
		
		for(int i = 0; i < locations_of_circles.size()/3; i++){
			if(locations_of_circles[i*3] < 1000000){
